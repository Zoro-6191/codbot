// this plugin manages all the voting
// commands: vote, votemap, votegametype, votemag, yes, no
...
module.exports = 
{
    init: async function()
    {
        pluginConf = conf.plugin.callvote
        mainconfig = conf.mainconfig
    },

    cmd_vote: async function()
    {

    },

    cmd_votemap: async function()
    {

    },
     
    cmd_votegametype: async function()
    {

    },

    cmd_votemag: async function()
    {

    },

    cmd_yes: async function()
    {

    },

    cmd_no: async function()
    {
